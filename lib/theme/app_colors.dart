...
class AppColors {
  // Primary Colors
  static const Color primary = Color.fromARGB(255, 247, 154, 154);
  static const Color primaryVariant = Color.fromARGB(255, 200, 155, 184);
  static const Color secondary = Color(0xFFB5E3F1);
